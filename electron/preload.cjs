...
contextBridge.exposeInMainWorld('dualCodexDay', Object.freeze({
  ...
  preflightProfile: (profileId, target) => ipcRenderer.invoke('profiles:preflight', { profileId, target }),
  ...
  listProfileRecoveryBackups: profileId => ipcRenderer.invoke('profiles:list-recovery-backups', profileId),
  previewProfileRecovery: (profileId, backupId) => ipcRenderer.invoke('profiles:preview-recovery', { profileId, backupId }),
  applyProfileRecovery: token => ipcRenderer.invoke('profiles:apply-recovery', token),
  discardProfileRecovery: token => ipcRenderer.invoke('profiles:discard-recovery', token),
  ...
  stopProfileLaunches: profileId => ipcRenderer.invoke('profiles:stop-all', profileId),
  openProfileFolder: profileId => ipcRenderer.invoke('profiles:open-folder', profileId),
  chooseWorkspace: () => ipcRenderer.invoke('workspace:choose'),
  activateWorkCombination: combinationId => ipcRenderer.invoke('work-combinations:activate', combinationId),
  setWorkCombinationPinned: (combinationId, pinned) => ipcRenderer.invoke('work-combinations:set-pinned', { combinationId, pinned }),
  repairWorkCombinationWorkspace: combinationId => ipcRenderer.invoke('work-combinations:repair-workspace', combinationId),
  removeWorkCombination: combinationId => ipcRenderer.invoke('work-combinations:remove', combinationId),
